...
const YBLRadioUI = ({ title, label, visibility, name, dataFilter, componentType, defaultValue, data,formName, selectedOption, onChange }) => {
        ...
        <div>
            ...
            <style jsx>{`
                ...
                .gender-option:not(:last-child) {
                    border-right: 4px solid #D1D5DB; /* Tailwind border-gray-300 */
                }
